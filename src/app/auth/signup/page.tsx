...
import { Building2, Mail, User, AlertCircle, Loader2, CheckCircle, MapPin, Phone, Globe, ClipboardList } from 'lucide-react';
...
export default function AgencySignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success
      setSuccess(true);
      setSubmittedEmail(data.email || formData.contactEmail);
    } catch (err) {
        ...
        <div className="w-full max-w-2xl">
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Thank you for your interest in joining our platform. We'll review your agency information and send an email to{' '}
              <span className="font-semibold text-[#0B4F96]">{submittedEmail}</span> once approved.
            </p>
            <div className="bg-blue-50 border-l-4 border-[#0B4F96] p-4 rounded-r-lg text-left mb-6">
              ...
              <ul className="mt-2 text-sm text-gray-600 space-y-1 list-disc list-inside">
                <li>Our team will review your agency information</li>
                <li>You'll receive an email with a link to set your password</li>
                <li>Once approved, you can start using the platform immediately</li>
              </ul>
            </div>
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-[#48ccbc] text-white rounded-lg font-bold hover:bg-[#3ab8a8] transition-all"
            >
              Return to Home
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Join our network of healthcare agencies</p>
        </div>
        ...
        <div className="bg-blue-50 border-l-4 border-[#0B4F96] p-4 rounded-r-lg mb-6 flex items-start gap-3">
          ...
          <div className="text-sm text-gray-700">
            <p className="font-semibold mb-1">No password needed at this time</p>
            <p>You'll receive an email to set your password once your agency is approved by our team.</p>
          </div>
        </div>
