...
export default function ComplianceDashboardPage() {
  ...
  const handleViewStaff = (staffId: string | null) => {
    if (!staffId) return;
        ...
        <div className="flex items-center justify-between mb-6 gap-4 flex-wrap">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Monitor credential expiration and review status across your organization
            </p>
          </div>
              ...
              <DocumentTable
                ...
                renderRow={(doc) => (
                  <tr key={doc.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <button
                        onClick={() => handleViewStaff(doc.staffMember.id)}
                        className="text-[#0B4F96] hover:text-[#48ccbc] p-1"
                  ...
                  <tr key={doc.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => handleViewStaff(doc.staffMember.id)} className="text-[#0B4F96] hover:text-[#48ccbc] p-1" title="View Staff">
                          <Eye className="h-4 w-4" />
                        </button>
