  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch('/api/waitlist', {
        ...
        body: JSON.stringify({ name: '', email, agencyName: '', tool: 'Community' }),
      });
      ...
      <div className="relative overflow-hidden bg-[#0B4F96] flex-shrink-0">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 pt-14 pb-12 md:pt-20 md:pb-16 text-center">
          ...
          <p className="text-blue-200 text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
            Connect with other home care and AFC agency operators across Massachusetts. Share best practices, ask questions, and grow together.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-lg w-full mx-auto px-4 sm:px-6 py-14">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
            ...
            <p className="text-gray-500 text-sm mb-6">
              We are building a peer community for Massachusetts home care operators. Leave your email and we will notify you when it launches.
            </p>
