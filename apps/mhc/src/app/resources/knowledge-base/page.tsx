...
// "Where to start" advice — skilled care only
// Unskilled/personal-care steps commented out — re-enable when personal care content goes live
const starterTips = [
  // {
  //   week: 'Weeks 1–12',
  //   icon: CheckCircle2,
      ...
      <div className="relative overflow-hidden bg-[#0B3D8C]">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 pt-14 pb-10 md:pt-20 md:pb-14 text-center">
          ...
          <p className="text-blue-200 text-base sm:text-lg mb-7 max-w-xl mx-auto leading-relaxed">
            Guides to hospitals, insurance plans, and health systems that send skilled home care referrals in Massachusetts.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-5">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">The highest-ROI referral channel for skilled care agencies</p>
            </div>
            <Link
              href="/resources/knowledge-base/how-to-use"
          ...
          <div className={`grid grid-cols-1 gap-3 ${starterTips.length > 1 ? 'sm:grid-cols-3' : ''}`}>
